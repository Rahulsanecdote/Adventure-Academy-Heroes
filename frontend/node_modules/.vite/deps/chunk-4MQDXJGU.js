...
import {
  extractMinAndMax
} from "./chunk-EFGLQGHA.js";
import {
  UniformBuffer
} from "./chunk-XUXGGHPQ.js";
import {
  FromHalfFloat
} from "./chunk-JEMKS53U.js";
import {
  Axis,
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name3, options = {}) {
    const module = await import("./webAudioBus-BDTARVM6.js");
  ...
  async createSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStaticSound-TMNB5OV5.js");
  ...
  async createSoundSourceAsync(name3, source, options = {}) {
    const module = await import("./webAudioSoundSource-CAW5ISRO.js");
  ...
  async createStreamingSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStreamingSound-IPMKRYH3.js");
...
//# sourceMappingURL=chunk-4MQDXJGU.js.map
